...
struct PolygonalMesh
{
    ...
    std::vector<unsigned int> Cell2DsVertices_Num = {}; ///< Cell2D id, size 1 x NumberCell2D
    std::vector<unsigned int> Cell2DsEdges_Num = {}; ///< Cell2D id, size 1 x NumberCell2D
    std::vector<unsigned int> Cell2DsId = {}; ///< Cell2D id, size 1 x NumberCell2D
    
    vector<vector<unsigned int>> Cell2DsVertices = {}; ///< Cell0D coordinates, size 2 x NumberCell0D (x,y)
    vector<vector<unsigned int>> Cell2DsEdges = {}; ///< Cell0D coordinates, size 2 x NumberCell0D (x,y)

    std::map<unsigned int, list<unsigned int>> MarkerCell2Ds = {}; ///< Cell2D markers
};
